...
def main():
    ...
    try:
        ...
        # world.try_spawn_actor(walker_controller_bp, carla.Transform(), pedestrians[0])
        # walker_controller_bp.start()
        # walker_controller_bp.go_to_location(world.get_random_location_from_navigation())
        # walker_controller_bp.set_max_speed(1 + random.random())  # Between 1 and 2 m/s (default is 1.4 m/s).
        # walker_controller_bp.stop()
