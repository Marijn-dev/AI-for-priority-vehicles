...
def main():
    ...
    try:
        ...
        human_ambulance = setup_vehicle(world, 'vehicle.ford.ambulance', spawn_points[172], autopilot=False, color='255,0,0')

        # Spawn regular cars
        car_models = ['vehicle.audi.a2', 'vehicle.toyota.prius', 'vehicle.citroen.c3']
        regular_cars = setup_vehicle(world, random.choice(car_models), spawn_points[173], autopilot=True)
